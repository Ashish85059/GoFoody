    ...
    <div className='dark'>
        ...
        <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel">
            <div className="carousel-inner">
                ...
                <div className="carousel-item">
                    <img src="https://source.unsplash.com/random/900x300/?pastry" className="d-block w-100" alt="Momos" />
                </div>
            </div>
            ...
            <div className='carousel-caption' style={{ zIndex: "10", position: "absolute", bottom: "20px", left: "50%", transform: "translateX(-50%)" }}>
                <div className="d-flex justify-content-center">
                    <input className="form-control me-2" type="search" placeholder="Search" aria-label="Search" value={search} onChange={(e)=>{setSearch(e.target.value)}} style={{ width: "70%" }} />
